...
public class ActivityFood extends AppCompatActivity {
    final Context context = ActivityFood.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Выбор питания");
    ...
    public ArrayList<CountryObject> getTestData() {
        ...
        Cursor cursor = mDb.query("food",
                new String[] {"food"},
                null, null, null, null, null);
        cursor.moveToFirst();
        String strCountry = "";
        int intCountry = cursor.getColumnIndex("food");
